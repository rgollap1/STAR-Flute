...
module mkTop_HW_Side(CLK,
  ...
  // submodule soc_top
  assign soc_top$put_from_console_put = v__h1284 ;
  ...
  begin
	...
	begin
	  v__h1284 = $imported_c_trygetchar(8'hAA);
	  #0;
	end
  end
  // synopsys translate_on
