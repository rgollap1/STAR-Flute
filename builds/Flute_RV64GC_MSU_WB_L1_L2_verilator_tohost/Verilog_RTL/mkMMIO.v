...
module mkMMIO(CLK,
  ...
  reg [63 : 0] _theResult_____2__h1518, mask__h1069, y__h1326;
  ...
  assign MUX_f_single_reqs$enq_1__VAL_1 =
	     { 1'd0, rg_pa, rg_req[204:203], final_st_val__h1459 } ;
  ...
  assign f_single_rsps_first__7_BIT_64_8_AND_NOT_rg_req_ETC___d125 =
	     ...
	     (rg_req[207:206] != 2'd2 || rg_req[74:70] != 5'b00010) &&
	     verbosity != 3'd0 ;
  assign final_ld_val__h1458 =
	     (rg_req[204:203] == 2'b10) ?
	       { {32{f_single_rspsD_OUT_BITS_31_TO_0__q1[31]}},
		 f_single_rspsD_OUT_BITS_31_TO_0__q1 } :
	       f_single_rsps$D_OUT[63:0] ;
  assign final_st_val__h1459 =
	     (rg_req[204:203] == 2'b10) ?
	       final_st_val__h1542 :
	       _theResult_____2__h1518 ;
  assign final_st_val__h1542 = { 32'd0, _theResult_____2__h1518[31:0] } ;
  assign final_st_val__h1632 =
	     final_ld_val__h1458 +
	     IF_rg_req_BITS_204_TO_203_6_EQ_0b10_1_THEN_SEX_ETC___d88 ;
  assign final_st_val__h1709 = w1__h1511 ^ w2__h1513 ;
  assign final_st_val__h1713 = w1__h1511 & w2__h1513 ;
  assign final_st_val__h1717 = w1__h1511 | w2__h1513 ;
  assign final_st_val__h1721 =
	     (w1__h1511 < w2__h1513) ? w1__h1511 : w2__h1513 ;
  assign final_st_val__h1726 =
	     (w1__h1511 <= w2__h1513) ? w2__h1513 : w1__h1511 ;
  assign final_st_val__h1732 =
	     ((final_ld_val__h1458 ^ 64'h8000000000000000) <
	      (IF_rg_req_BITS_204_TO_203_6_EQ_0b10_1_THEN_SEX_ETC___d88 ^
	       64'h8000000000000000)) ?
	       w1__h1511 :
	       w2__h1513 ;
  assign final_st_val__h1737 =
	     ((final_ld_val__h1458 ^ 64'h8000000000000000) <=
	      (IF_rg_req_BITS_204_TO_203_6_EQ_0b10_1_THEN_SEX_ETC___d88 ^
	       64'h8000000000000000)) ?
	       w2__h1513 :
	       w1__h1511 ;
  assign ld_val__h1052 =
	     (!rg_req[205] &&
	      CASE_rg_req_BITS_204_TO_203_0b0_f_single_rsps_ETC__q2) ?
	       result__h1314 :
	       result__h1381 ;
  assign result__h1314 = f_single_rsps$D_OUT[63:0] | y__h1326 ;
  assign result__h1381 = f_single_rsps$D_OUT[63:0] & mask__h1069 ;
  assign rg_req_BITS_106_TO_75__q3 = rg_req[106:75] ;
  assign w1___1__h1601 = { 32'd0, f_single_rsps$D_OUT[31:0] } ;
  assign w1__h1511 =
	     (rg_req[204:203] == 2'b10) ?
	       w1___1__h1601 :
	       f_single_rsps$D_OUT[63:0] ;
  assign w2___1__h1602 = { 32'd0, rg_req[106:75] } ;
  assign w2__h1513 =
	     (rg_req[204:203] == 2'b10) ? w2___1__h1602 : rg_req[138:75] ;
  always@(rg_req)
  begin
    case (rg_req[204:203])
      2'b0: mask__h1069 = 64'h00000000000000FF;
      2'b01: mask__h1069 = 64'h000000000000FFFF;
      2'b10: mask__h1069 = 64'h00000000FFFFFFFF;
      2'd3: mask__h1069 = 64'hFFFFFFFFFFFFFFFF;
    endcase
  end
  always@(rg_req)
  begin
    case (rg_req[204:203])
      2'b0: y__h1326 = 64'hFFFFFFFFFFFFFF00;
      2'b01: y__h1326 = 64'hFFFFFFFFFFFF0000;
      2'b10: y__h1326 = 64'hFFFFFFFF00000000;
      2'd3: y__h1326 = 64'd0;
    endcase
  end
  ...
  always@(rg_req or
	  final_st_val__h1737 or
	  final_st_val__h1632 or
	  w2__h1513 or
	  final_st_val__h1709 or
	  final_st_val__h1717 or
	  final_st_val__h1713 or
	  final_st_val__h1732 or final_st_val__h1721 or final_st_val__h1726)
  begin
    case (rg_req[74:70])
      5'b0: _theResult_____2__h1518 = final_st_val__h1632;
      5'b00001: _theResult_____2__h1518 = w2__h1513;
      5'b00100: _theResult_____2__h1518 = final_st_val__h1709;
      5'b01000: _theResult_____2__h1518 = final_st_val__h1717;
      5'b01100: _theResult_____2__h1518 = final_st_val__h1713;
      5'b10000: _theResult_____2__h1518 = final_st_val__h1732;
      5'b11000: _theResult_____2__h1518 = final_st_val__h1721;
      5'b11100: _theResult_____2__h1518 = final_st_val__h1726;
      default: _theResult_____2__h1518 = final_st_val__h1737;
    endcase
  end
  ...
  begin
    ...
    v__h2547 = v__h2556 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_req && verbosity != 3'd0) $display("%0d: %m.ma_req", v__h2547);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2726 = v__h2735 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_start && verbosity != 3'd0)
	$display("%0d: %m.ma_start", v__h2726);
    if (RST_N != `BSV_RESET_VALUE)
