...
module mkNear_Mem(CLK,
  ...
  begin
    case (i_mmu_cache$l1_to_l2_client_request_first[4:3])
      2'd0, 2'd1, 2'd2:
	  CASE_i_mmu_cachel1_to_l2_client_request_first_ETC__q1 =
	      i_mmu_cache$l1_to_l2_client_request_first[4:3];
      2'd3: CASE_i_mmu_cachel1_to_l2_client_request_first_ETC__q1 = 2'd3;
    endcase
  end
  always@(i_mmu_cache$l1_to_l2_client_request_first)
  begin
    case (i_mmu_cache$l1_to_l2_client_request_first[2:1])
      2'd0, 2'd1, 2'd2:
	  CASE_i_mmu_cachel1_to_l2_client_request_first_ETC__q2 =
	      i_mmu_cache$l1_to_l2_client_request_first[2:1];
      2'd3: CASE_i_mmu_cachel1_to_l2_client_request_first_ETC__q2 = 2'd3;
    endcase
  end
  always@(d_mmu_cache$l1_to_l2_client_request_first)
  begin
    case (d_mmu_cache$l1_to_l2_client_request_first[4:3])
      2'd0, 2'd1, 2'd2:
	  CASE_d_mmu_cachel1_to_l2_client_request_first_ETC__q3 =
	      d_mmu_cache$l1_to_l2_client_request_first[4:3];
      2'd3: CASE_d_mmu_cachel1_to_l2_client_request_first_ETC__q3 = 2'd3;
    endcase
  end
  always@(d_mmu_cache$l1_to_l2_client_request_first)
  begin
    case (d_mmu_cache$l1_to_l2_client_request_first[2:1])
      2'd0, 2'd1, 2'd2:
	  CASE_d_mmu_cachel1_to_l2_client_request_first_ETC__q4 =
	      d_mmu_cache$l1_to_l2_client_request_first[2:1];
