...
`endif
   ...
   (* always_ready *)  method CWord  ctag;
...
(* synthesize *)
module mkMMU_ICache  #(parameter Bool dmem_not_imem)  (MMU_ICache_IFC);
...
`endif
   ...
   Reg #(Bit #(64)) dw_output_ldtag_val     <- mkDWire (?);
