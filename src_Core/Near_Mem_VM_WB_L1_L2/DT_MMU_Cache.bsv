...
// Handles LD, ST, AMO_LR, AMO_SC, and remaining AMO_ops for tags.
//
...
//  - Uncacheable: request goes to the MMIO  module // this will be removed as tag are not available for uncacheable data
//
// For cacheable addrs:
