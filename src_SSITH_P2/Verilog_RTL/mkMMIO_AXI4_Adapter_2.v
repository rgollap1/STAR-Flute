...
module mkMMIO_AXI4_Adapter_2(CLK,
  ...
  wire [63 : 0] v__h3976,
		...
		v__h4075,
		word64___1__h3736,
		y_avValue_fst__h4816,
		y_avValue_fst__h5414,
		y_avValue_fst__h5987,
		y_avValue_fst__h6560;
  wire [7 : 0] x__h4418,
	       y_avValue_snd_snd_snd__h5004,
	       y_avValue_snd_snd_snd__h5600,
	       y_avValue_snd_snd_snd__h6173,
	       y_avValue_snd_snd_snd__h6746;
  wire [5 : 0] v__h4082, x__h4930, x__h5526, x__h6099, x__h6672;
  wire [2 : 0] x__h2208, x__h2592, x__h2941, x__h3290;
  ...
  assign MUX_ifc_f_rd_rsp_control$enq_1__VAL_1 =
	     { 2'd0, ifc_v_f_reqs_0$D_OUT[129:66], x__h2208, 8'd0 } ;
  assign MUX_ifc_f_rd_rsp_control$enq_1__VAL_2 =
	     { 2'd1, ifc_v_f_reqs_1$D_OUT[129:66], x__h2592, 8'd0 } ;
  assign MUX_ifc_f_rd_rsp_control$enq_1__VAL_3 =
	     { 2'd2, ifc_v_f_reqs_2$D_OUT[129:66], x__h2941, 8'd0 } ;
  assign MUX_ifc_f_rd_rsp_control$enq_1__VAL_4 =
	     { 2'd3, ifc_v_f_reqs_3$D_OUT[129:66], x__h3290, 8'd0 } ;
  ...
  // submodule ifc_master_xactor_f_rd_addr
  always@(WILL_FIRE_RL_ifc_rl_rd_req_3 or
  ...
  assign ifc_master_xactor_f_rd_addr$ENQ =
	     WILL_FIRE_RL_ifc_rl_rd_req_3 || WILL_FIRE_RL_ifc_rl_rd_req ||
	     WILL_FIRE_RL_ifc_rl_rd_req_1 ||
	     WILL_FIRE_RL_ifc_rl_rd_req_2 ;
  ...
  // submodule ifc_master_xactor_f_wr_addr
  always@(WILL_FIRE_RL_ifc_rl_wr_req_3 or
	  MUX_ifc_master_xactor_f_rd_addr$enq_1__VAL_1 or
  ...
  assign ifc_master_xactor_f_wr_addr$ENQ =
	     WILL_FIRE_RL_ifc_rl_wr_req_3 || WILL_FIRE_RL_ifc_rl_wr_req ||
	     WILL_FIRE_RL_ifc_rl_wr_req_1 ||
	     WILL_FIRE_RL_ifc_rl_wr_req_2 ;
  ...
  assign ifc_v_f_rsps_0$D_IN =
	     { ifc_master_xactor_f_rd_data$D_OUT[2:1] == 2'b0, v__h3991 } ;
  ...
  assign v__h3991 =
	     (ifc_f_rd_rsp_control$D_OUT[10:8] == 3'b011) ?
	       v__h3711 :
	       v__h4075 ;
  assign v__h4075 = v__h3711 >> v__h4082 ;
  assign v__h4082 = { ifc_f_rd_rsp_control$D_OUT[13:11], 3'b0 } ;
  assign word64___1__h3736 =
	     { ifc_master_xactor_f_rd_data$D_OUT[34:3],
	       ifc_rg_rd_data_buf[31:0] } ;
  assign x__h2208 = { 1'b0, ifc_v_f_reqs_0$D_OUT[65:64] } ;
  assign x__h2592 = { 1'b0, ifc_v_f_reqs_1$D_OUT[65:64] } ;
  assign x__h2941 = { 1'b0, ifc_v_f_reqs_2$D_OUT[65:64] } ;
  assign x__h3290 = { 1'b0, ifc_v_f_reqs_3$D_OUT[65:64] } ;
  assign x__h4418 = ifc_rg_rd_beat + 8'd1 ;
  assign x__h4930 = { ifc_v_f_reqs_0$D_OUT[68:66], 3'b0 } ;
  assign x__h5526 = { ifc_v_f_reqs_1$D_OUT[68:66], 3'b0 } ;
  assign x__h6099 = { ifc_v_f_reqs_2$D_OUT[68:66], 3'b0 } ;
  assign x__h6672 = { ifc_v_f_reqs_3$D_OUT[68:66], 3'b0 } ;
  assign y_avValue_fst__h4816 = ifc_v_f_reqs_0$D_OUT[63:0] << x__h4930 ;
  assign y_avValue_fst__h5414 = ifc_v_f_reqs_1$D_OUT[63:0] << x__h5526 ;
  assign y_avValue_fst__h5987 = ifc_v_f_reqs_2$D_OUT[63:0] << x__h6099 ;
  assign y_avValue_fst__h6560 = ifc_v_f_reqs_3$D_OUT[63:0] << x__h6672 ;
  assign y_avValue_snd_snd_snd__h5004 =
	     strb__h4743 << ifc_v_f_reqs_0$D_OUT[68:66] ;
  assign y_avValue_snd_snd_snd__h5600 =
	     strb__h5341 << ifc_v_f_reqs_1$D_OUT[68:66] ;
  assign y_avValue_snd_snd_snd__h6173 =
	     strb__h5914 << ifc_v_f_reqs_2$D_OUT[68:66] ;
  assign y_avValue_snd_snd_snd__h6746 =
  ...
  always@(ifc_rg_rd_beat or
	  ...
	  ifc_master_xactor_f_rd_data$D_OUT or word64___1__h3736)
  begin
    case (ifc_rg_rd_beat)
      8'd0: v__h3711 = ifc_master_xactor_f_rd_data$D_OUT[66:3];
      8'd1: v__h3711 = word64___1__h3736;
  ...
  begin
    ...
    v__h2048 = v__h2054 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req && verbosity != 3'd0)
	$display("%0d: %m.rl_rd_req", v__h2048);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req && verbosity != 3'd0)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req_1 && verbosity != 3'd0)
	$display("%0d: %m.rl_rd_req", v__h2458);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req_1 && verbosity != 3'd0)
	$write("    AXI4_Rd_Addr {araddr %0h arlen %d ",
	       ifc_v_f_reqs_1$D_OUT[129:66],
    ...
    v__h2807 = v__h2813 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req_2 && verbosity != 3'd0)
	$display("%0d: %m.rl_rd_req", v__h2807);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req_2 && verbosity != 3'd0)
	$write("    AXI4_Rd_Addr {araddr %0h arlen %d ",
	       ifc_v_f_reqs_2$D_OUT[129:66],
    ...
    v__h3156 = v__h3162 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req_3 && verbosity != 3'd0)
	$display("%0d: %m.rl_rd_req", v__h3156);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_req_3 && verbosity != 3'd0)
	$write("    AXI4_Rd_Addr {araddr %0h arlen %d ",
	       ifc_v_f_reqs_3$D_OUT[129:66],
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req && verbosity != 3'd0)
	$display("%0d: %m.rl_wr_req", v__h5229);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req && verbosity != 3'd0)
    ...
    v__h5802 = v__h5808 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req_1 && verbosity != 3'd0)
	$display("%0d: %m.rl_wr_req", v__h5802);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req_1 && verbosity != 3'd0)
	$write("    AXI4_Wr_Addr{awaddr %0h awlen %0d ",
	       ifc_v_f_reqs_1$D_OUT[129:66],
    ...
    v__h6375 = v__h6381 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req_2 && verbosity != 3'd0)
	$display("%0d: %m.rl_wr_req", v__h6375);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req_2 && verbosity != 3'd0)
	$write("    AXI4_Wr_Addr{awaddr %0h awlen %0d ",
	       ifc_v_f_reqs_2$D_OUT[129:66],
    ...
    v__h6948 = v__h6954 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req_3 && verbosity != 3'd0)
	$display("%0d: %m.rl_wr_req", v__h6948);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_req_3 && verbosity != 3'd0)
	$write("    AXI4_Wr_Addr{awaddr %0h awlen %0d ",
	       ifc_v_f_reqs_3$D_OUT[129:66],
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_data &&
	  ifc_master_xactor_f_rd_data$D_OUT[2:1] != 2'b0)
	$display("%0d: ERROR: %m.rl_rd_data: ERROR", v__h3557);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_data &&
	  ifc_master_xactor_f_rd_data$D_OUT[2:1] != 2'b0)
    ...
    v__h3761 = v__h3767 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_data && ifc_rg_rd_beat != 8'd0 &&
	  ifc_rg_rd_beat != 8'd1)
	$display("%0d: INTERNAL ERROR: %m.rl_rd_data", v__h3761);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_data && ifc_rg_rd_beat != 8'd0 &&
	  ifc_rg_rd_beat != 8'd1)
    ...
    v__h4496 = v__h4502 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_data && verbosity != 3'd0)
	$display("%0d: %m.rl_rd_data: ", v__h4496);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_rd_data && verbosity != 3'd0)
    ...
    v__h7284 = v__h7290 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_data && verbosity != 3'd0)
	$display("%0d: %m.rl_wr_data", v__h7284);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_data && verbosity != 3'd0)
    ...
    v__h7519 = v__h7525 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_rsp && ifc_rg_wr_rsps_pending == 4'd0)
	$display("%0d: %m.rl_wr_rsp:", v__h7519);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_rsp && ifc_rg_wr_rsps_pending == 4'd0)
    ...
    v__h7705 = v__h7711 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_rsp && ifc_rg_wr_rsps_pending != 4'd0 &&
	  ifc_master_xactor_f_wr_resp$D_OUT[1:0] != 2'b0)
	$display("%0d: %m.rl_wr_rsp", v__h7705);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_ifc_rl_wr_rsp && ifc_rg_wr_rsps_pending != 4'd0 &&
	  ifc_master_xactor_f_wr_resp$D_OUT[1:0] != 2'b0)
