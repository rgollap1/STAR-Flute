...
module mkD_MMU_Cache(CLK,
  ...
  wire f_dtmem_pte_writebacks$CLR,
       f_dtmem_pte_writebacks$DEQ,
       f_dtmem_pte_writebacks$EMPTY_N,
  ...
  wire [3 : 0] MUX_crg_exc_code$port0__write_1__VAL_2,
  ...
  wire [3 : 0] x1__h3778, x1__h5342, x1__h6245;
  wire NOT_crg_mmu_cache_req_port0__read__05_BITS_204_ETC___d128,
       ...
       cache_mv_is_idle__4_AND_crg_state_port0__read__ETC___d288,
  ...
  FIFO2 #(.width(32'd128), .guarded(1'd1)) f_dtmem_pte_writebacks(.RST(RST_N),
								  .CLK(CLK),
								  .D_IN(f_dtmem_pte_writebacks$D_IN),
								  .ENQ(f_dtmem_pte_writebacks$ENQ),
								  .DEQ(f_dtmem_pte_writebacks$DEQ),
								  .CLR(f_dtmem_pte_writebacks$CLR),
								  .D_OUT(f_dtmem_pte_writebacks$D_OUT),
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_crg_exc$port0__write_1__SEL_1:
	  crg_exc_code$port0__write_1 = x1__h5342;
      MUX_crg_exc$port0__write_1__SEL_2:
  ...
  assign cache_mv_is_idle__4_AND_crg_state_port0__read__ETC___d288 =
	     cache$mv_is_idle &&
	     (crg_state == 4'd5 ||
  ...
  begin
	...
	$display("Dynamic assertion failed: \"../src_Core/Near_Mem_VM_WB_L1_L2/D_MMU_Cache.bsv\", line 492, column 67\nFAIL: unknown vm_xlate result");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_CPU_req_B &&
	  crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d169 &&
	  tlb$mv_vm_xlate[200:199] != 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_rd_B && cache$mav_request_pa[129:128] == 2'd2)
	$display("%0d: %m.rl_ptw_rd_B", v__h7154);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_rd_B && cache$mav_request_pa[129:128] == 2'd2)
    ...
    v__h2414 = v__h2420 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
	$display("%0d: %m.rl_CPU_req", v__h2414);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
