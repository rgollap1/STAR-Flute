...
module mkDT_MMU_Cache(CLK,
  ...
  wire [3 : 0] x1__h3778, x1__h4889, x1__h5845;
  ...
  assign MUX_crg_exc_code$port0__write_1__VAL_3 =
	     (f_ptw_rsps$D_OUT[131:130] == 2'd1) ? x1__h4889 : x1__h5845 ;
  ...
  assign x1__h3778 =
	     (crg_mmu_cache_req[207:206] == 2'd0 ||
	      ...
	      crg_mmu_cache_req[74:70] == 5'b00010) ?
	       4'd4 :
	       4'd6 ;
  assign x1__h4889 = MUX_crg_exc_code$port0__write_1__VAL_2 ;
  assign x1__h5845 =
	     (crg_mmu_cache_req[207:206] == 2'd0 ||
	      crg_mmu_cache_req[207:206] == 2'd2 &&
	      crg_mmu_cache_req[74:70] == 5'b00010) ?
  ...
  begin
	...
	$display("Dynamic assertion failed: \"../src_Core/Near_Mem_VM_WB_L1_L2/DT_MMU_Cache.bsv\", line 429, column 67\nFAIL: unknown vm_xlate result");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_CPU_req_B &&
	  crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d192 &&
	  tlb$mv_vm_xlate[200:199] != 2'd1 &&
    ...
    v__h2463 = v__h2469 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
	$display("%0d: %m.rl_CPU_req", v__h2463);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
