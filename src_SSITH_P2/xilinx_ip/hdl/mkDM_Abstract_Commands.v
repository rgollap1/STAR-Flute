...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [31 : 0] virt_rg_abstractcs__h726, virt_rg_command__h776;
  wire [15 : 0] regno__h2735;
  wire [12 : 0] x__h1335, x__h1774;
  wire rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d38,
       ...
       rg_abstractcs_cmderr_1_EQ_0_09_AND_write_dm_ad_ETC___d144,
       rg_abstractcs_cmderr_1_EQ_0_09_AND_write_dm_ad_ETC___d176,
  ...
  always@(av_read_dm_addr or
	  rg_data1 or
	  rg_data0 or virt_rg_abstractcs__h726 or virt_rg_command__h776)
  begin
    case (av_read_dm_addr)
      7'h04: av_read = rg_data0;
      7'h16: av_read = virt_rg_abstractcs__h726;
      7'h17: av_read = virt_rg_command__h776;
  ...
  assign MUX_f_hart0_fpr_reqs$enq_1__VAL_1 =
	     { 1'd1, x__h1774[4:0], req_data__h860 } ;
  assign MUX_f_hart0_fpr_reqs$enq_1__VAL_2 =
	     { 1'd0, x__h1774[4:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_1 =
	     { 1'd1, x__h1335[4:0], req_data__h860 } ;
  assign MUX_f_hart0_gpr_reqs$enq_1__VAL_2 =
	     { 1'd0, x__h1335[4:0], 64'hAAAAAAAAAAAAAAAA } ;
  ...
  // remaining internal signals
  assign regno__h2735 = { 3'd0, rg_command_access_reg_regno } ;
  ...
  assign rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d72 =
	     ...
	     !rg_command_access_reg_regno_ULT_0x1020___d57 &&
	     rg_command_access_reg_regno_ULE_0x103F___d59 ;
  assign rg_abstractcs_cmderr_1_EQ_0_09_AND_write_dm_ad_ETC___d144 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_1_EQ_0_09_AND_write_dm_ad_ETC___d176 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
  ...
  assign virt_rg_abstractcs__h726 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd2 } ;
  assign virt_rg_command__h776 =
	     { 15'd17, rg_command_access_reg_write, regno__h2735 } ;
  ...
  assign x__h1335 = rg_command_access_reg_regno - 13'h1000 ;
  assign x__h1774 = rg_command_access_reg_regno - 13'h1020 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h04 &&
	  write_dm_addr != 7'h05)
	$write("%0d: DM_Abstract_Commands.write: [", v__h4352);
    if (RST_N != `BSV_RESET_VALUE)
