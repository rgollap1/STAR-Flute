...
module mkCore(CLK,
  ...
  begin
    ...
    v__h4241 = v__h4250 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h4241);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h4457 = v__h4466 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h4457);
  end
  // synopsys translate_on
endmodule  // mkCore
