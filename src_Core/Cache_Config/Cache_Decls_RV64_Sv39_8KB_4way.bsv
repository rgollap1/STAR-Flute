...
package Cache_Decls_RV64_Sv39_8KB_4way;
...
// Ways_per_CSet    =   4    (= 0x04)    (associativity)
...
typedef         4   Ways_per_CSet;    // (basic; associativity)
typedef         2   Bits_per_Way_in_CSet;    // log2 (Ways_per_CSet)

typedef       256   Bytes_per_CSet;    // Ways_per_CSet * Bytes_per_CLine
...
typedef        32   CSets_per_Cache;    // Bytes_per_Cache / Bytes_per_CSet
typedef         5   Bits_per_CSet_in_Cache;    // log2 (CSets_per_Cache)
...
typedef        53   Bits_per_CTag;    // Bits_per_PA - (Bits_per_CSet_in_Cache + Bits_per_Byte_in_CLine)
...
Integer                 ways_per_cset =        4;    // (basic; associativity)
Integer          bits_per_way_in_cset =        2;    // log2 (Ways_per_CSet)

Integer                bytes_per_cset =      256;    // Ways_per_CSet * Bytes_per_CLine
...
Integer               csets_per_cache =       32;    // Bytes_per_Cache / Bytes_per_CSet
Integer        bits_per_cset_in_cache =        5;    // log2 (CSets_per_Cache)
...
Integer                 bits_per_ctag =       53;    // Bits_per_PA - (Bits_per_CSet_in_Cache + Bits_per_Byte_in_CLine)
...
Integer   addr_hi_cset_cword_in_cache =       10;    // addr_lo_cword_set_in_cache + Bits_per_CWord_Set_in_Cache - 1
...
endpackage: Cache_Decls_RV64_Sv39_8KB_4way
