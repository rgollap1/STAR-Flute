...
module mkUART(CLK,
  ...
  wire [7 : 0] fn_iir__h1320,
	       rdata_byte__h3203,
	       y_avValue_snd__h3162,
	       y_avValue_snd__h3171,
	       y_avValue_snd__h3178,
	       y_avValue_snd__h3185;
  wire [1 : 0] rdr_rresp__h3234,
	       v__h3500,
	       v__h3720,
	       v__h3896,
	       y_avValue_fst__h3184,
	       y_avValue_fst__h3191,
	       y_avValue_fst__h3198;
  ...
  // register rg_dll
  assign rg_dll$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_dll$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d251 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_dlm
  assign rg_dlm$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_dlm$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d260 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_fcr
  assign rg_fcr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_fcr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d264 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_ier
  assign rg_ier$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_ier$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d256 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_lcr
  assign rg_lcr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_lcr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d268 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_mcr
  assign rg_mcr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_mcr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d272 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_scr
  assign rg_scr$D_IN = WILL_FIRE_RL_rl_reset ? 8'd0 : x__h4179[7:0] ;
  assign rg_scr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d276 ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  // register rg_thr
  assign rg_thr$D_IN = x__h4179[7:0] ;
  assign rg_thr$EN =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     NOT_slave_xactor_f_wr_addr_first__43_BITS_92_T_ETC___d185 ;
  ...
  // submodule f_to_console
  assign f_to_console$D_IN = x__h4179[7:0] ;
  ...
  assign rdata___1__h3258 = { 24'd0, rdata_byte__h3203, 32'd0 } ;
  ...
  assign rdata_byte__h3203 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_U_ETC___d12 ||
	      ...
	      59'd0) ?
	       8'd0 :
	       y_avValue_snd__h3185 ;
  assign rdr_rdata__h3233 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[2:0] ==
	      3'b100) ?
	       rdata___1__h3258 :
	       rdata__h3204 ;
  assign rdr_rresp__h3234 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_U_ETC___d12 ||
	      !slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_U_ETC___d14) ?
	       2'b11 :
	       y_avValue_fst__h3198 ;
  assign result__h4193 = { 56'd0, slave_xactor_f_wr_data$D_OUT[16:9] } ;
  assign result__h4223 = { 56'd0, slave_xactor_f_wr_data$D_OUT[24:17] } ;
  assign result__h4250 = { 56'd0, slave_xactor_f_wr_data$D_OUT[32:25] } ;
  assign result__h4277 = { 56'd0, slave_xactor_f_wr_data$D_OUT[40:33] } ;
  assign result__h4304 = { 56'd0, slave_xactor_f_wr_data$D_OUT[48:41] } ;
  assign result__h4331 = { 56'd0, slave_xactor_f_wr_data$D_OUT[56:49] } ;
  assign result__h4358 = { 56'd0, slave_xactor_f_wr_data$D_OUT[64:57] } ;
  assign result__h4385 = { 56'd0, slave_xactor_f_wr_data$D_OUT[72:65] } ;
  assign result__h4412 = { 48'd0, slave_xactor_f_wr_data$D_OUT[24:9] } ;
  assign result__h4439 = { 48'd0, slave_xactor_f_wr_data$D_OUT[40:25] } ;
  assign result__h4466 = { 48'd0, slave_xactor_f_wr_data$D_OUT[56:41] } ;
  assign result__h4493 = { 48'd0, slave_xactor_f_wr_data$D_OUT[72:57] } ;
  assign result__h4520 = { 32'd0, slave_xactor_f_wr_data$D_OUT[40:9] } ;
  assign result__h4547 = { 32'd0, slave_xactor_f_wr_data$D_OUT[72:41] } ;
  ...
  assign v__h3720 =
	     (slave_xactor_f_wr_addr_first__43_BITS_92_TO_29_ETC___d149[63:5] ==
	      59'd0) ?
	       v__h3896 :
	       2'b11 ;
  assign v__h3896 = y_avValue_fst__h3184 ;
  assign y_avValue_fst__h3184 = 2'b0 ;
  assign y_avValue_fst__h3191 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[63:5] ==
	      59'd0) ?
	       y_avValue_fst__h3184 :
	       2'b11 ;
  assign y_avValue_fst__h3198 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[1:0] ==
	      2'd0) ?
	       y_avValue_fst__h3191 :
	       2'b10 ;
  assign y_avValue_snd__h3162 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[4:2] ==
	      3'h1 &&
	      rg_lcr[7]) ?
	       rg_dlm :
	       y_avValue_snd__h3153 ;
  assign y_avValue_snd__h3171 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[4:2] ==
	      ...
	      !rg_lcr[7]) ?
	       rg_ier :
	       y_avValue_snd__h3162 ;
  assign y_avValue_snd__h3178 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[4:2] ==
	      3'h0 &&
	      rg_lcr[7]) ?
	       rg_dll :
	       y_avValue_snd__h3171 ;
  assign y_avValue_snd__h3185 =
	     (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[4:2] ==
	      3'h0 &&
	      !rg_lcr[7]) ?
	       rg_rbr :
  ...
  always@(slave_xactor_f_wr_data$D_OUT or
	  ...
	  result__h4331 or
	  result__h4466 or
	  result__h4358 or result__h4385 or result__h4493 or result__h4547)
  begin
    case (slave_xactor_f_wr_data$D_OUT[8:1])
      8'b00000001: x__h4179 = result__h4193;
      8'b00000010: x__h4179 = result__h4223;
      8'b00000011: x__h4179 = result__h4412;
      8'b00000100: x__h4179 = result__h4250;
      8'b00001000: x__h4179 = result__h4277;
      8'b00001100: x__h4179 = result__h4439;
      8'b00001111: x__h4179 = result__h4520;
      8'b00010000: x__h4179 = result__h4304;
      8'b00100000: x__h4179 = result__h4331;
      8'b00110000: x__h4179 = result__h4466;
      8'b01000000: x__h4179 = result__h4358;
      8'b10000000: x__h4179 = result__h4385;
      8'b11000000: x__h4179 = result__h4493;
      8'b11110000: x__h4179 = result__h4547;
      8'b11111111: x__h4179 = slave_xactor_f_wr_data$D_OUT[72:9];
      default: x__h4179 = 64'd0;
    endcase
  end
  ...
  begin
    case (slave_xactor_f_rd_addr_first_BITS_92_TO_29_0_M_ETC___d30[4:2])
      3'h2: y_avValue_snd__h3153 = fn_iir__h1320;
      3'h3: y_avValue_snd__h3153 = rg_lcr;
      3'h4: y_avValue_snd__h3153 = rg_mcr;
      3'h5: y_avValue_snd__h3153 = rg_lsr;
      3'h6: y_avValue_snd__h3153 = rg_msr;
      3'h7: y_avValue_snd__h3153 = rg_scr;
      default: y_avValue_snd__h3153 = 8'd0;
    endcase
  end
