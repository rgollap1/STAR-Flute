...
module mkCore(CLK,
  ...
  FIFO2 #(.width(32'd427), .guarded(1'd1)) f_trace_data_merged(.RST(RST_N),
							       .CLK(CLK),
  ...
  begin
    ...
    v__h6157 = v__h6163 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h6157);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h6328 = v__h6334 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_dm_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_dm_start", v__h6328);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h6640 = v__h6646 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h6640);
  end
  // synopsys translate_on
endmodule  // mkCore
