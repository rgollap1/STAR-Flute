...
module mkI_MMU_Cache(CLK,
  ...
  // inlined wires
  reg [4 : 0] crg_exc_code$port0__write_1;
  ...
  wire [7 : 0] crg_ld_tag$port0__write_1, crg_ld_tag$port1__read;
  wire [4 : 0] crg_exc_code$port1__read;
  ...
  reg [4 : 0] crg_exc_code;
  wire [4 : 0] crg_exc_code$D_IN;
  wire crg_exc_code$EN;

  // register crg_ld_tag
  reg [7 : 0] crg_ld_tag;
  wire [7 : 0] crg_ld_tag$D_IN;
  wire crg_ld_tag$EN;
  ...
  wire [137 : 0] cache$mav_request_pa;
  ...
  wire NOT_crg_mmu_cache_req_port0__read__05_BITS_204_ETC___d128,
       ...
       NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d229,
       NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d235,
       ...
       crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d218,
       soc_map_m_is_mem_addr_tlb_mv_vm_xlate_crg_mmu__ETC___d352,
  ...
  // submodule cache
  mkICache #(.dcache_not_icache(1'd0), .verbosity(3'd0)) cache(.CLK(CLK),
							       .RST_N(RST_N),
  ...
  assign MUX_crg_exc_code$port0__write_1__VAL_3 =
	     (f_ptw_rsps$D_OUT[131:130] == 2'd1) ? 5'd1 : 5'd12 ;
  ...
  assign MUX_crg_valid$port0__write_1__VAL_1 =
	     ...
	     (tlb$mv_vm_xlate[201:200] == 2'd2 ||
	      ...
	      cache$mav_request_pa[137:136] != 2'd0) ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
	  ...
	  crg_exc_code$port0__write_1 = 5'd1;
  ...
  assign crg_ld_val$port0__write_1 =
	     MUX_crg_ld_val$port0__write_1__SEL_1 ?
	       cache$mav_request_pa[135:72] :
	       mmio$result_snd_fst ;
  assign crg_ld_val$port1__read =
	     crg_ld_val$EN_port0__write ?
	       crg_ld_val$port0__write_1 :
	       crg_ld_val ;
  assign crg_ld_tag$EN_port0__write =
	     WILL_FIRE_RL_rl_CPU_req_B &&
	     crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d211 ||
	     WILL_FIRE_RL_rl_CPU_req_mmio_WAIT ;
  assign crg_ld_tag$port0__write_1 =
	     MUX_crg_ld_val$port0__write_1__SEL_1 ?
	       cache$mav_request_pa[7:0] :
	       8'd0 ;
  assign crg_ld_tag$port1__read =
	     crg_ld_tag$EN_port0__write ?
	       crg_ld_tag$port0__write_1 :
	       crg_ld_tag ;
  ...
  // register crg_ld_tag
  assign crg_ld_tag$D_IN = crg_ld_tag$port1__read ;
  assign crg_ld_tag$EN = 1'b1 ;
  ...
  assign mmio$start_pa = tlb$mv_vm_xlate[199:136] ;
  ...
  assign soc_map$m_is_mem_addr_addr = tlb$mv_vm_xlate[199:136] ;
  ...
  assign NOT_crg_mmu_cache_req_port0__read__05_BITS_204_ETC___d175 =
	     ...
	     (tlb$mv_vm_xlate[201:200] == 2'd2 ||
	      soc_map$m_is_mem_addr &&
	      cache$mav_request_pa[137:136] == 2'd1) ;
  assign NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d229 =
	     tlb$mv_vm_xlate[201:200] != 2'd2 && soc_map$m_is_mem_addr &&
	     cache$mav_request_pa[137:136] == 2'd2 &&
	     crg_mmu_cache_req[207:206] == 2'd2 ;
  assign NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d235 =
	     tlb$mv_vm_xlate[201:200] != 2'd2 && soc_map$m_is_mem_addr &&
	     cache$mav_request_pa[137:136] == 2'd2 &&
	     crg_mmu_cache_req[207:206] != 2'd2 ;
  ...
  assign crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d211 =
	     ...
	     soc_map$m_is_mem_addr &&
	     cache$mav_request_pa[137:136] != 2'd0 ;
  assign crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d218 =
	     crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d182 &&
	     tlb$mv_vm_xlate[201:200] != 2'd1 &&
	     tlb$mv_vm_xlate[201:200] != 2'd2 &&
	     soc_map$m_is_mem_addr &&
	     cache$mav_request_pa[137:136] == 2'd2 ;
  assign soc_map_m_is_mem_addr_tlb_mv_vm_xlate_crg_mmu__ETC___d352 =
	     soc_map$m_is_mem_addr && cache$mav_request_pa[137:136] == 2'd2 &&
	     crg_mmu_cache_req[207:206] == 2'd2 &&
  ...
  begin
    ...
    if (crg_ld_tag$EN) crg_ld_tag <= `BSV_ASSIGNMENT_DELAY crg_ld_tag$D_IN;
  ...
  begin
	...
	$display("Dynamic assertion failed: \"../../src_Core/Near_Mem_VM_WB_L1_L2/I_MMU_Cache.bsv\", line 395, column 67\nFAIL: unknown vm_xlate result");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_CPU_req_B &&
	  crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d182 &&
	  tlb$mv_vm_xlate[201:200] != 2'd1 &&
    ...
    v__h4358 = v__h4367 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_CPU_req_B &&
	  crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d218)
	$display("%0d: %m.rl_CPU_req_B", v__h4358);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_CPU_req_B &&
	  crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d218)
	begin
    ...
    v__h2371 = v__h2380 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
	$display("%0d: %m.rl_CPU_req", v__h2371);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
