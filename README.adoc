...
the ISA layer). *Status: as of 2026-07-04 the STAR tree `bsc`-compiles clean
(`bsc` 2026.01) and links a Bluesim simulator.* See `Doc/STAR/10-building.md`
for the full recipe, the build-status log, and why behavioral validation needs
tagged binaries.
