...
module mkIntMul_64(CLK,
  ...
  wire [127 : 0] x__h244, x__h351, xy___1__h255;
  wire [63 : 0] _theResult___fst__h494,
		_theResult___fst__h497,
		_theResult___fst__h548,
		_theResult___fst__h551,
		_theResult___snd_fst__h543;
  ...
  // inputs to muxes for submodule ports
  assign MUX_m_rg_x$write_1__VAL_1 = { 64'd0, _theResult___fst__h494 } ;
  assign MUX_m_rg_x$write_1__VAL_2 = { m_rg_x[126:0], 1'd0 } ;
  assign MUX_m_rg_xy$write_1__VAL_2 = (m_rg_y == 64'd0) ? x__h244 : x__h351 ;
  ...
  assign _theResult___fst__h494 =
	     put_args_x_is_signed ? _theResult___fst__h497 : put_args_x ;
  assign _theResult___fst__h497 = put_args_x[63] ? -put_args_x : put_args_x ;
  assign _theResult___fst__h548 =
	     put_args_y_is_signed ? _theResult___fst__h551 : put_args_y ;
  assign _theResult___fst__h551 = put_args_y[63] ? -put_args_y : put_args_y ;
  assign _theResult___snd_fst__h543 =
	     put_args_x_is_signed ? put_args_y : _theResult___fst__h548 ;
  assign x__h244 = m_rg_isNeg ? xy___1__h255 : m_rg_xy ;
  assign x__h351 = m_rg_xy + m_rg_x ;
  assign xy___1__h255 = -m_rg_xy ;
