...
module mkD_MMU_Cache(CLK,
  ...
  wire [3 : 0] x1__h3849, x1__h5472, x1__h6439;
  ...
  FIFO2 #(.width(32'd128), .guarded(32'd1)) f_dmem_pte_writebacks(.RST(RST_N),
								  .CLK(CLK),
  ...
  FIFO2 #(.width(32'd128), .guarded(32'd1)) f_imem_pte_writebacks(.RST(RST_N),
								  .CLK(CLK),
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_crg_exc$port0__write_1__SEL_2:
	  crg_exc_code$port0__write_1 = x1__h5472;
      MUX_crg_exc$port0__write_1__SEL_3:
	  crg_exc_code$port0__write_1 =
	      MUX_crg_exc_code$port0__write_1__VAL_3;
      WILL_FIRE_RL_rl_CPU_req_mmio_WAIT:
  ...
  begin
    ...
    v__h2471 = v__h2477 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
	$display("%0d: %m.rl_CPU_req", v__h2471);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
