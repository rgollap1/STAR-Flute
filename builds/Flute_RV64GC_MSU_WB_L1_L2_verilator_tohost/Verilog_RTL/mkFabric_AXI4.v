...
module mkFabric_AXI4(CLK,
  ...
  wire [1 : 0] IF_fabric_v_rg_r_beat_count_0_53_EQ_fabric_v_f_ETC___d471,
	       ...
	       x1_avValue_rresp__h17765,
	       x1_avValue_rresp__h18414,
	       x1_avValue_rresp__h19053;
  ...
  assign x__h17780 = fabric_v_rg_r_beat_count_0 + 8'd1 ;
  assign x__h18429 = fabric_v_rg_r_beat_count_1 + 8'd1 ;
  assign x__h19068 = fabric_v_rg_r_beat_count_2 + 8'd1 ;
  assign x__h21409 = fabric_v_rg_r_err_beat_count_0 + 8'd1 ;
  assign x__h21791 = fabric_v_rg_r_err_beat_count_1 + 8'd1 ;
  ...
  begin
    ...
    v__h5786 = v__h5795 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (fabric_rg_reset && fabric_cfg_verbosity != 4'd0)
	$display("%0d: %m.rl_reset", v__h5786);
  end
  // synopsys translate_on
