...
module mkDma_Server_Mux_Fabric(CLK,
  ...
  wire [7 : 0] x__h11062, x__h12225, x__h12607, x__h7430, x__h8123;
  wire [1 : 0] IF_fabric_v_rg_r_beat_count_0_04_EQ_fabric_v_f_ETC___d222,
	       x1_avValue_rresp__h11040;
  ...
  FIFO2 #(.width(32'd9), .guarded(1'd1)) fabric_v_f_wd_tasks_0(.RST(RST_N),
							       .CLK(CLK),
  ...
  FIFO2 #(.width(32'd9), .guarded(1'd1)) fabric_v_f_wd_tasks_1(.RST(RST_N),
							       .CLK(CLK),
  ...
  assign x1_avValue_rresp__h11040 =
	     (fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_0_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] ;
  assign x__h11062 = fabric_v_rg_r_beat_count_0 + 8'd1 ;
  assign x__h12225 = fabric_v_rg_r_err_beat_count_0 + 8'd1 ;
  assign x__h12607 = fabric_v_rg_r_err_beat_count_1 + 8'd1 ;
  assign x__h7430 = fabric_v_rg_wd_beat_count_0 + 8'd1 ;
  assign x__h8123 = fabric_v_rg_wd_beat_count_1 + 8'd1 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (fabric_rg_reset && fabric_cfg_verbosity != 4'd0)
	$display("%0d: %m.rl_reset", v__h3963);
  end
  // synopsys translate_on
