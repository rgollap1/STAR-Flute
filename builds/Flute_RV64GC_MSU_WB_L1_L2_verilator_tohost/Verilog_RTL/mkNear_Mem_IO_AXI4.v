...
module mkNear_Mem_IO_AXI4(CLK,
  ...
  reg [63 : 0] _theResult___fst__h2505;
  reg [1 : 0] _theResult___snd__h2506, v__h3313;
  ...
  assign crg_time$port1__write_1 =
	     MUX_crg_time$port1__write_1__SEL_1 ? new_time__h5030 : 64'd1 ;
  ...
  assign crg_timecmp_port1__read__50_AND_INV_SEXT_slave_ETC___d189 =
	     new_timecmp__h3723 - old_time__h7609 ;
  assign mask__h3750 =
	     { SEXT_slave_xactor_f_wr_data_first__06_BIT_8_51___d152,
	       SEXT_slave_xactor_f_wr_data_first__06_BIT_7_54___d155,
	       SEXT_slave_xactor_f_wr_data_first__06_BIT_6_58___d159,
  ...
  assign new_time__h5030 = x__h5068 | y__h3762 ;
  assign new_timecmp__h3723 = x__h3761 | y__h3762 ;
  assign old_time__h7609 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata___1__h2501 = { 63'd0, rg_msip } ;
  assign rg_msip_7_EQ_slave_xactor_f_wr_data_first__06__ETC___d108 =
	     rg_msip == slave_xactor_f_wr_data$D_OUT[9] ;
  assign rresp__h2484 =
	     slave_xactor_f_rd_addr_first__1_BITS_92_TO_29__ETC___d53 ?
	       2'b11 :
	       _theResult___snd__h2506 ;
  ...
  assign x__h2685 =
	     slave_xactor_f_rd_addr_first__1_BITS_92_TO_29__ETC___d53 ?
	       64'd0 :
	       _theResult___fst__h2505 ;
  assign x__h3761 = crg_timecmp & y__h3763 ;
  assign x__h5068 = old_time__h7609 & y__h3763 ;
  assign y__h3762 = slave_xactor_f_wr_data$D_OUT[72:9] & mask__h3750 ;
  assign y__h3763 =
	     { ~SEXT_slave_xactor_f_wr_data_first__06_BIT_8_51___d152,
	       ~SEXT_slave_xactor_f_wr_data_first__06_BIT_7_54___d155,
	       ~SEXT_slave_xactor_f_wr_data_first__06_BIT_6_58___d159,
  ...
  begin
    case (byte_addr__h2323)
	  ...
	  _theResult___snd__h2506 = 2'b0;
      default: _theResult___snd__h2506 = 2'b11;
    endcase
  end
  always@(byte_addr__h2323 or rdata___1__h2501 or crg_timecmp or crg_time)
  begin
    case (byte_addr__h2323)
      64'h0: _theResult___fst__h2505 = rdata___1__h2501;
      64'h0000000000000004: _theResult___fst__h2505 = 64'd0;
      64'h0000000000004000, 64'h0000000000004004:
	  _theResult___fst__h2505 = crg_timecmp;
      64'h000000000000BFF8, 64'h000000000000BFFC:
	  _theResult___fst__h2505 = crg_time;
      default: _theResult___fst__h2505 = 64'd0;
    endcase
  end
  ...
  begin
    ...
    v__h2805 = v__h2814 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("%0d: Near_Mem_IO_AXI4.rl_process_rd_req", v__h2805);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$write("            ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h3287 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h3723);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3287 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        cur MTIME            = 0x%0h", old_time__h7609);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3287 == 64'h0000000000004000 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h3287 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        old MTIME = 0x%0h", old_time__h7609);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3287 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        new MTIME = 0x%0h", new_time__h5030);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3287 == 64'h0000000000004004 &&
    ...
    v__h9091 = v__h9100 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("%0d: Near_Mem_IO.AXI4.rl_process_wr_req", v__h9091);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$write("            ");
