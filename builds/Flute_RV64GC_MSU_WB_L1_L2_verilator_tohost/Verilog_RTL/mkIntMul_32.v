...
module mkIntMul_32(CLK,
  ...
  wire [63 : 0] x__h247, x__h354, xy___1__h258;
  wire [31 : 0] _theResult___fst__h497,
		_theResult___fst__h500,
		_theResult___fst__h551,
		_theResult___fst__h554,
		_theResult___snd_fst__h546;
  ...
  // inputs to muxes for submodule ports
  assign MUX_m_rg_x$write_1__VAL_1 = { 32'd0, _theResult___fst__h497 } ;
  assign MUX_m_rg_x$write_1__VAL_2 = { m_rg_x[62:0], 1'd0 } ;
  assign MUX_m_rg_xy$write_1__VAL_2 = (m_rg_y == 32'd0) ? x__h247 : x__h354 ;
  ...
  assign _theResult___fst__h497 =
	     put_args_x_is_signed ? _theResult___fst__h500 : put_args_x ;
  assign _theResult___fst__h500 = put_args_x[31] ? -put_args_x : put_args_x ;
  assign _theResult___fst__h551 =
	     put_args_y_is_signed ? _theResult___fst__h554 : put_args_y ;
  assign _theResult___fst__h554 = put_args_y[31] ? -put_args_y : put_args_y ;
  assign _theResult___snd_fst__h546 =
	     put_args_x_is_signed ? put_args_y : _theResult___fst__h551 ;
  assign x__h247 = m_rg_isNeg ? xy___1__h258 : m_rg_xy ;
  assign x__h354 = m_rg_xy + m_rg_x ;
  assign xy___1__h258 = -m_rg_xy ;
