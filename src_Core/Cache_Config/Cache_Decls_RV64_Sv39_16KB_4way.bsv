...
package Cache_Decls_RV64_Sv39_16KB_4way;

// ================================================================
// Basic sizes, from which everything else is derived

// Bits_per_PA      =  64    (= 0x40)    (bits per physical addr)
// KB_per_Cache     =  16    (= 0x10)    (cache size)
...
typedef        16   KB_per_Cache;    // (basic)
typedef     16384   Bytes_per_Cache;    // KB_per_Cache * 1024
typedef      2048   CWords_per_Cache;    // Bytes_per_Cache / Bytes_per_CWord
...
Integer                  kb_per_cache =       16;    // (basic)
Integer               bytes_per_cache =    16384;    // KB_per_Cache * 1024
Integer              cwords_per_cache =     2048;    // Bytes_per_Cache / Bytes_per_CWord
...
endpackage: Cache_Decls_RV64_Sv39_16KB_4way
