...
// predict_rsp_cur_priv           I     2 unused
// bp_train_pc                    I    64
...
module mkBranch_Predictor(CLK,
  ...
  input  [1 : 0] predict_rsp_cur_priv;
  ...
  wire [63 : 0] _theResult_____1__h2384,
  ...
  // value method predict_rsp
  assign predict_rsp =
	     (_theResult_____1__h2384 == 64'hFFFFFFFFFFFFFFFF) ?
	       pred_pc__h3341 :
	       _theResult_____1__h2384 ;
  ...
  assign IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d208 =
	     { IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d204,
	       bp_train_is_i32_not_i16 ? ret_pc__h4044 : ret_pc___1__h4082 } ;
  ...
  assign _theResult_____1__h2384 =
	     (_theResult____h2383 == 64'hFFFFFFFFFFFFFFFF &&
  ...
  assign predict_rsp_instr_BITS_15_TO_12_6_EQ_0b1001_7__ETC___d30 =
	     ...
	     predict_rsp_instr[6:2] == 5'd0 &&
	     predict_rsp_instr[1:0] == 2'b10 ;
  assign ret_pc___1__h4082 = bp_train_pc + 64'd2 ;
  assign ret_pc__h4044 = bp_train_pc + 64'd4 ;
